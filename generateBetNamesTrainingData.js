...
(async () => {
    ...
    try {
        ...
        console.log(loggit, "Generating File betNamesTrainingData.json")
        await fs.promises.writeFile("./data/betNamesTrainingData.json", JSON.stringify(jsonToGo, null, 2));

        console.log(loggit, "Successfully Generated File betNamesTrainingData.json")
